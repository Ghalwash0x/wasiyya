...
const Login = () => {
    ...
    useEffect(() => {
        ...
        const oauthTemp = params.get('tempToken');
        ...
        if (needs2FA && oauthTemp) {
            setTempToken(oauthTemp);
            setMethods({
                    ...
                    <>
                        <div className="text-center mb-6">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                {methods.passkey && methods.totp ? 'Passkey أو كود التطبيق'
                                    : methods.passkey ? 'استخدم Passkey'
                        ...
                        {methods.passkey && passkeyOk && (
                            <button type="button" onClick={handlePasskeyLogin} disabled={loading}
                                className="w-full mb-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg py-3 text-sm font-semibold transition-colors disabled:opacity-60">
                                {loading ? 'جاري التحقق...' : '🔑 الدخول بـ Passkey'}
                            </button>
                        )}
